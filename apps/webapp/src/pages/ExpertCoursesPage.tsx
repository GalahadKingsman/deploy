  ...
  return (
    <PageScreen>
      ...
      {!isLoading && !error && items.length === 0 ? (
        <div className="edify-empty-panel">
          <div className="edify-empty-panel__title">Курсов пока нет</div>
          <p className="edify-empty-panel__text">Нажмите «Новый курс», чтобы начать.</p>
        </div>
      ) : null}
